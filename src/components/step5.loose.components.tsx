...
import { looseAgregateParams } from "../assets/urci-params/params.data";
...
const LooseComponent: React.FC<Props> = ({
  onDataUpdate,
  meassuredLength,
  meassuredWidth,
  meassuredArea,
      ...
      <div className="w-full">
        <div className="flex gap-2 sm:gap-3 items-center">
          <div className="w-7 h-7 sm:w-8 sm:h-8 bg-crayola rounded-full flex items-center justify-center">
            <p className="font-semibold text-lg md:text-xl text-alabaster">5</p>
          </div>
        ...
        <div className="w-full sm:w-1/2 bg-white p-2 rounded mt-0 sm:mt-2">
          <ul className="sm:text-sm text-xs list-disc pl-4">
            ...
            <p className="text-vermilion">
              Loose aggregate lebih dari 10 cm, kecepatan kendaraan menurun.
            </p>
            <li>Medium</li>
            <p className="text-vermilion">
              Loose aggregate 5-10 cm, kecepatan kendaraan menurun.
            </p>
            <li>Low</li>
            <p className="text-vermilion">
              Loose aggregate maksimal 5 cm, kecepatan kendaraan normal.
            </p>
          </ul>
        </div>
      </div>
